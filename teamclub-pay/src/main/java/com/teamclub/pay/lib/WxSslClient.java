...
public class WxSslClient {
    ...
    public  static WxSslClient instance = new WxSslClient();
     ...
     */
    public WxSslClient(String cert, String certPassword) {
        KeyStore keyStore = null;
        SSLContext sslcontext = null;
        try {
            keyStore = KeyStore.getInstance("PKCS12");
            InputStream inputStream = new ByteArrayInputStream(Base64.decode(cert));
